export const poseInstructions = {
    Tree: [
        'Get into position. Tree pose often starts with both feet planted firmly on the ground and your weight adequately distributed so that you are balanced.',
        ...
        'Tree Pose supports and strengthens the spine. This asana helps in improving both your balance of the body and posture.','Source: https://www.masterclass.com/articles/tree-pose-explained'
        ],
    Cobra: [
        ...
        'Bhujangasana is very useful to keep your back healthy.','Source: Yoga Journal - https://www.yogajournal.com/poses/types/cobra-pose-2/'
    ],
    Dog: [
        ...
        'Dog should be held for at least 30 seconds.',
        'The longer the stretch is held the more you maximize the stretch and relax the muscles.','Source: Yoga Journal - https://www.yogajournal.com/poses/types/downward-facing-dog/'
    ...
    Chair: [
        ...
        'To come out of this pose, straighten your knees with an inhalation, lifting strongly through your arms. Exhale and release your arms to your sides. ','Source: classpass - https://classpass.com/movements/chair-pose'
    ],
    Warrior: [
        ...
        '20 seconds or as long as you can. Over time, increase your hold times to build endurance.','Source classpass - https://classpass.com/movements/warrior-3-pose'
    ],
    Traingle: [
        ...
        'In Trikonasana yoga, hold for 10 to 30 seconds and alternate sides 3 to 6 times.','Source classpass - https://classpass.com/movements/triangle-pose'
    ],
    Shoulderstand: [
        ...
        'Lift your hips off of the mat coming into bridge pose and extend your arms onto the ground, palms facing down as if your hands could touch your heels. ',
...
export const tutorials = [
    '1. When app asks for permission of camera, allow it to access to capture pose.',
