...
def normalize_pose_landmarks(landmarks):
    """Here we Normalized landmark translation by moving pose center 
    to constant pose size.
  """
  # Move landmarks so that the pose center becomes (0,0)
    ...
    # Scale landmarks to constant pose size
...
def landmarks_to_embedding(landmarks_and_scores):
    """for pose setting we are changing keras layers values"""
